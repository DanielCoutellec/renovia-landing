          ...
          <div className="flex-1">
            <div className="relative mx-auto flex max-w-md items-end justify-center gap-2 md:gap-3">
              {mobileScreens.map((src, index) => (
                <div
                  key={index}
                  className={`relative h-64 w-28 overflow-hidden rounded-3xl border border-slate-200 bg-slate-900 shadow-[0_16px_40px_rgba(15,23,42,0.35)] md:h-72 md:w-32 ${
                    index === 2
                      ? "z-20 scale-110"
                      : index === 1 || index === 3
            ...
            <p className="mt-4 text-center text-[11px] text-slate-500">
              ...
              <span className="font-semibold"> ergonomie mobile</span> pour les
              visites, états des lieux et suivis de travaux.
            </p>
          </div>
        </div>
      </section>
            ...
            <div className="flex min-w-max gap-4">
              {mobileScreens.map((src, index) => (
                <div
                  ...
                  className="relative h-80 w-40 shrink-0 overflow-hidden rounded-[2.1rem] border border-slate-200 bg-slate-900 shadow-[0_20px_50px_rgba(15,23,42,0.4)]"
                >
        ...
        <div className="mx-auto flex max-w-6xl flex-col gap-4 px-4 md:flex-row md:items-center md:justify-between">
          ...
          <div className="space-y-2 text-xs">
            ...
            <p className="text-[11px] text-slate-500">
              © {new Date().getFullYear()} CDSM SARL. Tous droits
              réservés.
            </p>
          </div>
        </div>
